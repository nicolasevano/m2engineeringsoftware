...
public class ArticleWSImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://mule.esb.stage.sodifrance.com/", "ArticleWSImplService");
    public final static QName ArticleWSImplPort = new QName("http://mule.esb.stage.sodifrance.com/", "ArticleWSImplPort");
    static {
        URL url = null;
        try {
