...
public class ArticleTransformer {
    ...
    private static final transient Logger LOG = LoggerFactory.getLogger(ArticleTransformer.class);
     ...
     */
    @Converter
    public Article toArticle(PossibleArticle doc, Exchange exchange) throws Exception {
        ...
        article.setAuthor(doc.getAuthor());
