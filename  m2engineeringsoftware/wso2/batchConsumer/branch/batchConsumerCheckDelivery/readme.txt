...
Voici les paramétres à utiliser pour garantir le fonctionnement avec mysql quand la base installé sur l'hote local:
...
TODO
L'écriture dans un fichier sans l'écraser est actuellement indisponible avec WSO2 aussi bien que le dernier accusé de réception 
soit présent dans le fichier C:/log/batchConsumer/trap.txt les traps (accusés de réceptions des duex file jms de fin de traitement) sont redirigés dans les logs pour 
le moment.