...
public class AllTestFieldsEnabledAfterClickOnNewButton extends UITestCaseSwing {

	/**
	 * Create an Instance
	 */
	public AllTestFieldsEnabledAfterClickOnNewButton() {
	 ...
	 * Main test method.
	 */
	public void testAllTestFieldsEnabledAfterClickOnNewButton()
			throws Exception {
		IUIContext ui = getUI();
		ui.click(new JButtonLocator("New"));
		//check if each text field is enable
