...
public class ConcreteMM implements MoteurMetronome {
	...
	public ConcreteMM( Controler controler ){
		...
		this.tempo = 2;
		this.state = false;
		commands.put( commandName[2], ( ( Command ) new GenererSon( this ) ) );
		commands.put( commandName[3], ( ( Command ) new GenererEclairSurLED1( this ) ) );
		commands.put( commandName[4], ( ( Command ) new GenererEclairSurLED2( this ) ) );
